...
function Navbar(){
    ...
    return(
        <div className="navbar border-b-[1px] border-black h-[60px] w-full overflow-hidden flex items-center justify-between pr-4 pl-4">
            ...
            <div className={`max-[565px]:fixed  max-[565px]:w-[80%] transition-all duration-1000 z-[2]  ${menu===false ? "max-[565px]:left-[-200%] top-[0px] h-[0%]" : "top-[0px] left-0  h-[100vh]"}  bg-white h-[100vh] flex justify-end max-[565px]:justify-start  w-full`}>
