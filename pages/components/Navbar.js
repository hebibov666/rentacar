...
<a href='#cars' onClick={closeMenu}><li className='list  flex flex-col box-border'>Maşınlar</li></a>
<a href='#advantages' onClick={closeMenu}><li className='list  flex flex-col'>Niyə biz?</li></a>
<a href='#rules' onClick={closeMenu}><li className='list  flex flex-col'>Qaydalar</li></a>
<a href='#aboutus' onClick={closeMenu}><li className='list  flex flex-col'>Haqqımızda</li></a>
<a href='#contact' onClick={closeMenu}><li className='list flex flex-col'>Əlaqə</li></a>
                </ul>
            </div>
