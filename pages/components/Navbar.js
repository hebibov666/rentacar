...
<a href='#haqqimizda'><li className='list  flex flex-col box-border'>{t('Maşınlar')}</li></a>
<a href='#gallery'><li className='list  flex flex-col'>{t('Haqqımızda')}</li></a>
<a href='#contact'><li className='list flex flex-col'>{t('Əlaqə')}</li></a>
<LanguageSelector/>
                </ul>
            </div>
